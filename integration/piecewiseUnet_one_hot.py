...
class PiecewiseLinearUNet(tfb.Bijector):
    """
    ...
    def __init__(self, D, d, nbins, layer_id=0, validate_args=False, name="PiecewiseLinear"):
        ...
        """
        super(PiecewiseLinearUNet, self).__init__(
...
class PiecewiseQuadraticUNet(tfb.Bijector):
    """
    ...
    def __init__(self, D, d, nbins, layer_id=0, validate_args=False, name="PiecewiseQuadratic"):
        ...
        Args:
            ...
            d: First d units are pass-thru units.
        """
        super(PiecewiseQuadraticUNet, self).__init__(
                forward_min_event_ndims=1, validate_args=validate_args, name=name,
        )
...
class PiecewiseQuadraticConstUNet(tfb.Bijector):
    """
    ...
    def __init__(self, D, d, nbins, layer_id=0, validate_args=False, name="PiecewiseQuadraticConst"):
        ...
        Args:
            ...
            d: First d units are pass-thru units.
        """
        super(PiecewiseQuadraticConstUNet, self).__init__(
                forward_min_event_ndims=1, validate_args=validate_args, name=name,
        )
